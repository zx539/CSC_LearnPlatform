...
2. 资源生成智能体：生成 5 类个性化学习资源（文档/思维导图/练习题/阅读材料/代码案例）。
3. 路径规划智能体：根据画像与资源制定学习路径及推送策略。
4. 智能辅导智能体：按“结论→原理→例子”结构答疑。
5. 学习评估智能体：输出多维评分、诊断与计划调整建议。

### 2.2 前端页面

- 标签页：**学习画像 / 学习资源 / 学习路径 / 学习评估 / 智能辅导**
- 明亮活泼风格：渐变背景、圆角卡片、胶囊标签、色彩强调按钮
- 支持 Markdown 渲染资源内容（`marked`）
...
├── profile.json
├── learning_path.json
├── evaluation.json                # 仅当传入 progress 时
└── resources/
    ├── 课程讲解文档.md
    ├── 知识点思维导图(Mermaid).md
    ├── 分层练习题(含答案与解析).md
